...
function deleteMany(){
	...
	location.href="deleteMany.action?rids="+selboxes;
	}
}
		...
		<tr>
			...
			<td width="935" height="29" valign="top"
				background="../admin/images/content-bg.gif"><table width="100%"
					...
					<tr>
						<td height="31"><div class="titlebt">查询角色</div></td>
					</tr>
				</table></td>
			...
			<td valign="top" bgcolor="#F7F8F9"><table width="100%"
					...
					<tr>
						<td valign="top"><table width="98%" border="0" align="center"
								...
								<tr>
									<td class="left_txt">当前位置：查询角色</td>
								</tr>
								<tr>
								...
								<tr>
									<td><table width="100%" height="55" border="0"
											...
											<tr>
												...
												<td width="90%" valign="top"><span class="left_txt2">在这里，您可以查询角色的信息</span><span
													class="left_txt3"></span><span class="left_txt2">！</span><br>
													<span class="left_txt2">包括：</span><span class="left_txt3">角色id</span><span
													class="left_txt2">，角色名</span><span
																		...
																		<td><table width="100%" border="0"
																				...
																				<s:iterator value="list">
																					<tr>
																						...
																						<td height="20" bgcolor="#FFFFFF"><div
																								align="center">
																								<span class="STYLE4"><a href="showRoleDetails.action?rid=<s:property value='rid'/>"><img
																									src="../quanxian/image/edt.gif" width="16" height="16" />编辑</a>&nbsp;
																									&nbsp;<a href="deleteByRid.action?rid=<s:property value='rid'/>"><img src="../quanxian/image/del.gif" width="16"
